...
- **COMPLETION:** Once you have gathered all necessary information, you MUST call the `finish_task` tool to conclude the loop. Provide your final answer in the same message as this tool call. **CRITICAL:** Do NOT mention the name of the tool (e.g., "I will now call finish_task") or provide any preamble/postamble about calling it. Simply provide the answer and the tool call in one message.
- **NO REPETITION:** If you have already provided your final answer but forgot to call `finish_task`, DO NOT repeat your answer or explain yourself. Simply call the `finish_task` tool to conclude.
